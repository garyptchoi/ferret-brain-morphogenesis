function [map,bigtri] = spherical_conformal_map(v,f,bigtri)
...
% (Optional) bigtri: ID of the face to be punctured during the process
% 
% Output:
% map: nv x 3 vertex coordinates of the spherical conformal parameterization
% bigtri: ID of the face to be punctured during the process
%
...
if nargin < 3
    ...
    % Use the one specified in the input
    %
